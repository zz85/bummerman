// From three.js cf1366af122a026b3828f6b34b17a81aa51dbfc3
/*
...
THREE.ClarkSubdivisionModifier = function ( subdivisions ) {
...
THREE.ClarkSubdivisionModifier.prototype.modify = function ( geometry ) {
...
THREE.ClarkSubdivisionModifier.prototype.smooth = function ( oldGeometry ) {
	...
	THREE.computeCentroids(newGeometry	);
...
THREE.convertFace4s = function(geometry) {

	var newGeo = new THREE.Geometry();

	newGeo.vertices = geometry.vertices.concat();
