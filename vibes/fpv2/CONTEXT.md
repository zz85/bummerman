...
### Game Modes
- Single player: FPV with mouse look, kill all enemies to win
...
- Procedural background music: bass drone, arpeggio, kick drum pattern
- Music auto-mutes when game is paused
